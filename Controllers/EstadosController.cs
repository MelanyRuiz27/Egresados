...
namespace EgresadosU.Controllers
{
    public class EstadosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IdGrupo,Descripcion")] Estados estados)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdGrupo,Descripcion")] Estados estados)
        {
            if (ModelState.IsValid)
            {
